...
public abstract class MixinMinecraftServer {
    ...
    public void redotick(CallbackInfo ci) {
        ...
        } else if (TASBattle.isRunning) {
            getPlayerManager().sendToAll(new WorldBorderS2CPacket(((MinecraftServer) (Object) this).getWorld(TASBattle.worldReg).getWorldBorder(), WorldBorderS2CPacket.Type.LERP_SIZE));
        }
    }
